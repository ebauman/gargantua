...
import (
	...
	informers "github.com/hobbyfarm/gargantua/pkg/generated/informers/externalversions"
...
func (c *Factory) Terraformcontroller() Interface {
	return New(c.controllerManager, c.informerFactory.Terraformcontroller(), c.clientset)
}
